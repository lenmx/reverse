...
func filterTables(tables []*schemas.Table, target *common.ReverseTarget) []*schemas.Table {
...
func runReverse(source *common.ReverseSource, target *common.ReverseTarget) error {
	...
	var tableMapper = common.ConvertString2Mapper(target.TableMapper)
	var colMapper = common.ConvertString2Mapper(target.ColumnMapper)
